...
const FeaturePropertyCard = ({property}) => {
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-center gap-4 text-gray-500 mb-4">
                <p>
                  <FaBed className='inline-block mx-1'/> {property.beds}{' '}
                  <span className="md:hidden lg:inline">Beds</span>
                </p>
                <p>
                  <FaBath className='inline-block mx-1'/> {property.baths}{' '}
              ...
              <div className="flex flex-col lg:flex-row justify-between">
                <div className="flex align-middle gap-2 mb-4 lg:mb-0">
                  <FaMapMarker className='text-red-500 relative top-1 inline-block mr-1'/>
                  <span className="text-orange-700"> {property.location.state}{' '} {property.location.street} </span>
                </div>
                <Link
