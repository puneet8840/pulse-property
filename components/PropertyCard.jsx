...
import {FaBed,FaBath,FaRulerCombined,FaMapMarker,FaMoneyBill,FaAirFreshener} from 'react-icons/fa'
            ...
            <div className="p-4">
              ...
              <div className="flex flex-col lg:flex-row justify-between mb-4">
                <div className="flex align-middle gap-2 mb-4 lg:mb-0">
                  ...
                  ></i>
                  <span className="text-orange-700"> <FaMapMarker className='inline mr-2'/>{property.location.city}{property.location.state} </span>
                </div>
                <Link
