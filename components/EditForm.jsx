...
const EditForm = () => {
  ...
  setFields((prevFields)=>({...prevFields,[outerkey]:{...prevFields[outerkey],[innerkey]:value,}}))
  ...
  setFields((preFields)=>({...preFields,amenities:updatedAmenities}))
  };
  ...
  return (mounted && !loading &&  (<section className="bg-blue-50">
        <div className="container m-auto max-w-2xl py-24">
          <div
            className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0"
          >
            <form   onSubmit={handleUpdate}>
              <h2 className="text-3xl text-center font-semibold mb-6" style={{backgroundColor:"#0049B7"}}>
                <ShinyText 
  text="Edit Property" 
  disabled={false} 
  speed={2} 
